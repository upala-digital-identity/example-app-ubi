...
async function readOnChainData() {
  ...
  const ceaErc20 = new Contract(addresses[1].ceaErc20, abis.erc20, defaultProvider);
...
function App() {
  ...
  const loadWeb3Modal = useCallback(async () => {
    ...
    // console.log("addresses_by_network", addresses_by_network)
    // let network;
    // switch (chain_id) {
    //   case 1:
    ...
    console.log(abis.UBIExampleDApp);
    setUbiApp(new Contract(
